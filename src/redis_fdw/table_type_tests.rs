...
mod tests {
    ...
    fn test_redis_hash_table() {
        ...
        assert_eq!(
            hash_table.get_row(0, None),
            Some(vec!["name".to_string(), "John".to_string()])
        );
        assert_eq!(
            hash_table.get_row(1, None),
            Some(vec!["age".to_string(), "30".to_string()])
        );
        assert_eq!(
            hash_table.get_row(2, None),
    ...
    fn test_redis_list_table() {
        ...
        assert_eq!(
            list_table.get_row(1, None),
            Some(vec!["banana".to_string()])
        );
        assert_eq!(
            list_table.get_row(2, None),
    ...
    fn test_redis_set_table() {
        ...
        // Add some data
        set_table.data = vec!["red".to_string(), "green".to_string(), "blue".to_string()];
        ...
        assert_eq!(
            set_table.get_row(0, Some(&filtered_data)),
            Some(vec!["yellow".to_string()])
        );
        assert_eq!(
            set_table.get_row(1, Some(&filtered_data)),
    ...
    fn test_redis_zset_table() {
        ...
        assert_eq!(
            zset_table.get_row(0, Some(&filtered_data)),
            Some(vec!["player4".to_string(), "120.0".to_string()])
        );
        assert_eq!(
            zset_table.get_row(1, Some(&filtered_data)),
    ...
    fn test_list_table_advanced_operations() {
        ...
        assert_eq!(
            list_table.get_row(0, None),
            Some(vec!["item_0".to_string()])
        );
        assert_eq!(
            list_table.get_row(999, None),
    ...
    fn test_set_table_advanced_operations() {
        ...
        assert_eq!(
            set_table.get_row(0, Some(&filtered)),
            Some(vec!["admin".to_string()])
        );
        assert_eq!(
            set_table.get_row(3, Some(&filtered)),
    ...
    fn test_string_table_advanced_operations() {
        ...
        assert_eq!(
            string_table.get_row(0, Some(&filtered)),
    ...
    fn test_filtered_data_functionality() {
        ...
        assert_eq!(
            hash_table.get_row(0, Some(&hash_filtered)),
            Some(vec!["field1".to_string(), "value1".to_string()])
        );
        assert_eq!(
            hash_table.get_row(1, Some(&hash_filtered)),
        ...
        assert_eq!(
            list_table.get_row(0, Some(&list_filtered)),
            Some(vec!["item1".to_string()])
        );
        assert_eq!(
            list_table.get_row(2, Some(&list_filtered)),
        ...
        assert_eq!(
            set_table.get_row(0, Some(&set_filtered)),
        ...
        assert_eq!(
            zset_table.get_row(0, Some(&zset_filtered)),
        ...
        assert_eq!(
            string_table.get_row(0, Some(&string_filtered)),
            Some(vec!["filtered_value".to_string()])
        );
    }
}
